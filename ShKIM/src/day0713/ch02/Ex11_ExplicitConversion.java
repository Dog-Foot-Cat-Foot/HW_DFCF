...
public class Ex11_ExplicitConversion {
	...
	public static void main(String[] args) {
		...
		// double형 변수 dNum1 선언과 동시에 1.2 데이터 대입
		double dNum1 = 1.2;
		// float형 변수 fNum2 선언과 동시에 (float)0.9 데이터 대입
		float fNum2 = 0.9f;
		
		// int형 변수 iNum3 선언과 동시에 
		...
		// int형 변수 iNum3, iNum4의 데이터 출력
		System.out.println(iNum3); // 출력: 1
		System.out.println(iNum4); // 출력: 2
