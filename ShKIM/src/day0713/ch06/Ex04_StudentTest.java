...
public class Ex04_StudentTest {
	...
	public static void main(String[] args) {
		...
		// Student형 참조 변수 studentKim에 Student 인스턴스 생성하여 메모리 주소값 대입
		Student studentKim = new Student();
		// studentKim 참조 변수를 통해 studentName 멤버 변수 대입
		studentKim.setStudentName("김석진");
		
		// serialNum 데이터 출력
		// System.out.println(studentKim.serialNum); // 1000
		
		// 클래스 이름으로 serialNum 변수 데이터 출력
		...
		// Student형 참조 변수 studentPark에 Student 인스턴스 생성하여 메모리 주소값 대입
		Student studentPark = new Student();
		// studentPark 참조 변수를 통해 studentName 멤버 변수 대입
